...
@SoulStoneItems(id = "coal_ore_soul_stone")
public class CoalOreSoulStone extends BaseSoulStone implements ISoulStoneHit{
    ...
    public void afterHit(LivingDamageEvent event, LivingEntity attacker, LivingEntity target, ItemStack stack){
        ...
        if (target instanceof WitherSkeleton) {
            spawnItemFromEntity(target, new ItemStack(Items.COAL, CSDY_RANDOM.nextInt(1,3)));
        }
    }
